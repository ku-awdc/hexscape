# /Library/Frameworks/R.framework/Resources/Rscript -e "source('notebooks/germany.R')"
...
land_use <- extract_corine("DE", verbose=2L)
...
save(patches, neighbours, map, file="patches/patches_germany.rda")
